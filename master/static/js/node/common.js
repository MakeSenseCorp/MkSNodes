...
function Modal () {
	...
	this.RegisterCloseEvent = function (callback) {
		document.getElementById("idMakesenseModalCloseButton").onclick = callback;
	}

	this.SetTitle = function (name) {
		document.getElementById("idMakesenseModalTitleName").innerHTML = name;
	}
...
var ModalBuilder = (function () {
	...
	ModalHTML = `
		<div class="modal fade bd-example-modal-lg" id="idMakesenseModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="idMakesenseModalTitleName">Information</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close" id="idMakesenseModalCloseButton">
